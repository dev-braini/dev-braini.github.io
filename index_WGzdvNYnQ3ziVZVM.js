...
// Google Closure Compiter: https://closure-compiler.appspot.com/
(function () {
    'use strict';
    ...
    DistanceMeter.prototype = {
        ...
        setRank: function (distance) {
            ...
            if(distance >= points*8) {
                label = 'jump on';
                rank = 'You are a monster!';
            } else if(distance >= points*7) {
                label = 'jump on';
                rank = 'INSANE';
    ...
    Horizon.prototype = {
        ...
        addNewObstacle: function (currentSpeed) {
            ...
            // console.log('current speed:', currentSpeed.toFixed(1));
